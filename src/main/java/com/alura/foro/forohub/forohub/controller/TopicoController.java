...
import com.alura.foro.forohub.forohub.dominio.topico.*;
...
public class TopicoController {
    ...
    public ResponseEntity detallar(@PathVariable Long id){
        ...
        if(topicoOptional.isEmpty()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Upps, no existe un tópico con el ID ingresado.");
        }
    ...
    public ResponseEntity eliminar(@PathVariable Long id){
        ...
        if(topico.isEmpty()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body("Upps, no existe un tópico con el ID ingresado.");
        }
